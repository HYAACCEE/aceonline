...
$.fn.pagination.defaults={total:1,pageSize:15,pageNumber:1,pageList:[15,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_75,_76){
},onBeforeRefresh:function(_77,_78){
},onRefresh:function(_79,_7a){
},onChangePageSize:function(_7b){
},beforePageText:"页",afterPageText:"共 {pages} 页",displayMsg:"当前显示第 {from} - {to} 条，共 {total} 条记录"};
})(jQuery);
(function($){
function _7c(_7d){
var _7e=$(_7d);
...
if(_b1(_91,_a0).treeState=="closed"){
...
var _ce=_cc[i];
if(_ce.treeState!="open"&&_ce.treeState!="closed"){
_ce.treeState="open";
}
var _cf=$("<div class=\"tree-node\"></div>").appendTo(li);
_cf.attr("node-rowid",_ce.rowid);
$.data(_cf[0],"tree-node",{rowid:_ce.rowid,text:_ce.text,iconCls:_ce.iconCls,attributes:_ce.attributes});
$("<span class=\"tree-title\"></span>").html(_ce.text).appendTo(_cf);
if(_c6.checkbox){
if(_c6.onlyLeafCheck){
if(_ce.treeState=="open"&&(!_ce.children||!_ce.children.length)){
if(_ce.checked){
...
_d1(_db,_e0[0],{rowid:_df.rowid},function(){
if(_de.animate){
...
node.attr("node-rowid",data.rowid);
...
if(!_bd(_11e,_11f)){
node.treeState=$(_11f).find(".tree-hit").hasClass("tree-expanded")?"open":"closed";
}
return node;
};
function _120(_121,rowid){
var node=$(_121).find("div.tree-node[node-rowid="+rowid+"]");
if(node.length){
...
return jq.each(function(){
if($.data(this,"panel"))_16c(this,_19d);
});
...
$.fn.panel.defaults={title:null,iconCls:null,width:"auto",height:"auto",appendTo:"body",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:[],href:null,loadingMessage:"Loading...",onLoad:function(){
...
$(this).appendTo(_1bc.options.appendTo); //.appendTo("body");
}
}
_1ad(this);
_1b6(this);
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",appendTo:"body",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
win.window({title:_1df,width:460,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
var opts=$.extend({showType:"slide",showSpeed:600,width:100,height:150,msg:"",title:"",timeout:4000},_1e3||{});
...
if(_56e){
_572(_56e);
_571.find("tr[node-rowid="+_56e+"]").next("tr.treegrid-tr-tree").find("tr[node-rowid]").each(function(){
_572($(this).attr("node-rowid"));
});
}else{
_571.find("tr[node-rowid]").each(function(){
_572($(this).attr("node-rowid"));
});
if(opts.showFooter){
...
function _572(_578){
var tr1=_570.find("tr[node-rowid="+_578+"]");
var tr2=_571.find("tr[node-rowid="+_578+"]");
tr1.css("height","");
tr2.css("height","");
...
body.find("tr[node-rowid]").unbind(".treegrid").bind("mouseenter.treegrid",function(){
var id=$(this).attr("node-rowid");
body.find("tr[node-rowid="+id+"]").addClass("datagrid-row-over");
}).bind("mouseleave.treegrid",function(){
var id=$(this).attr("node-rowid");
body.find("tr[node-rowid="+id+"]").removeClass("datagrid-row-over");
...
var id=$(this).parent().parent().parent().attr("node-rowid");
if(opts.singleSelect){
_582(_57e);
_5b9(_57e,id);
}else{
...
var tr1=_586.children("div.datagrid-body").find("tr[node-rowid="+_585+"]");
var tr2=_587.children("div.datagrid-body").find("tr[node-rowid="+_585+"]");
...
if(node){
var _592=_590.children("div.datagrid-body").find("tr[node-rowid="+_58e+"]");
var _593=_591.children("div.datagrid-body").find("tr[node-rowid="+_58e+"]");
...
var _59e=body.find("tr[node-rowid="+_599+"] span.tree-folder");
...
var node=view.find("div.datagrid-body tr[node-rowid="+_5b6+"]").children("td[field="+opts.treeField+"]");
...
var tr=body.find("tr[node-rowid="+_5bb+"]");
tr.addClass("datagrid-row-selected");
...
var tr=body.find("tr[node-rowid="+_5be+"]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
function _581(_5bf){
var tr=$(_5bf).datagrid("getPanel").find("div.datagrid-body tr[node-rowid]");
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",true);
};
function _582(_5c0){
var tr=$(_5c0).datagrid("getPanel").find("div.datagrid-body tr[node-rowid]");
tr.removeClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").attr("checked",false);
};
...
var tr=body.find("tr[node-rowid="+_5c3+"]");
...
var tr=body.find("tr[node-rowid="+_5c6+"]");
var hit=tr.find("span.tree-hit");
...
var tr=body.find("tr[node-rowid="+_5cb+"]");
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_5c1(_5ca,_5cb);
}else{
...
var tr=body.find("tr[node-rowid="+_5d9.parent+"]");
...
var tr=body.find("tr[node-rowid="+_5dd+"]");
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _5de=del(_5dd);
if(_5de){
if(_5de.children.length==0){
tr=body.find("tr[node-rowid="+_5de[opts.treeField]+"]");
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
var tr=body.find("tr[node-rowid="+id+"]");
tr.next("tr.treegrid-tr-tree").remove();
var hit=tr.find("span.tree-hit");
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
_5c4(this,id);
...
_5fc.push("<tr node-rowid="+row[opts.idField]+">");
...
return $(_612).datagrid("getPanel").find("div.datagrid-body tr[node-rowid="+id+"]");
...
_6cf(this,q);
}},currentText:"今日",closeText:"关闭",okText:"Ok",formatter:function(date){
...
var ao=s.split(" ");
var d=$.fn.datebox.defaults.parser(ao[0]);
var tt=ao[1].split(":");
