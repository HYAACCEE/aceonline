...
-- Created by Administrator on 2017/4/5, 8:37:00 --
---------------------------------------------------

set define off
spool PCACE_20170405_00.log
...
create or replace package body pcace.pkg_pcace_web is
  ...
  begin
    ...
    update B_Candidate set
           ...
           c11 = v_age,
           c12 = v_xingzuo,
           (c41,c38,c40,c42,c43,c44,c45)= (select NVL(b.c2,a.c5), a.c7,decode(a.c4,'至今',1,0), a.c9, a.c11, a.c12, a.c13 from (select rownum rownum_,m.* from B_Candidate_CVWork m where c1=a_cid order by c3 desc) a, A_Organ b where a.c5=b.c2(+)||'['||b.c1(+)||']' and a.rownum_=1)
     where c1=a_cid;
