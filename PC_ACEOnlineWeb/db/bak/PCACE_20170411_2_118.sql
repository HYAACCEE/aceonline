...
-- Created by Administrator on 2017/4/11, 8:36:51 --
----------------------------------------------------

set define off
spool PCACE_20170411_2_118.log
  ...
  begin
    ...
    if counter > 0 then
        ...
        update B_Candidate t set
               (c41,c38,c40,c42,c43,c44,c45)= (select distinct NVL(b.c2,a.c5), a.c7,decode(a.c4,'至今',1,0), a.c9, a.c11, a.c12, a.c13 from B_Candidate_CVWork a, A_Organ b where a.dataid=(select max(dataid) from B_Candidate_CVWork m where c1=a_cid and c2=130001 and c5 is not null) and a.c5=b.c2(+)||'['||b.c1(+)||']')
         where c1=a_cid;
