...
-- Created by Administrator on 2017/1/10, 17:49:02 --
-----------------------------------------------------

set define off
spool PCACE_20170110_02.log
...
prompt
prompt Creating table A_COMPANY
prompt ========================
prompt
create table PCACE.A_COMPANY
(
  dataid       NUMBER(11) not null,
  datasctlevel NUMBER(6) default -1,
  datastatus   NUMBER(6) default -1,
...
prompt
prompt Creating table B_ACETASK
prompt ========================
prompt
create table PCACE.B_ACETASK
(
  dataid       NUMBER(11) not null,
  datasctlevel NUMBER(6) default -1,
  datastatus   NUMBER(6) default -1,
...
prompt
prompt Creating table B_CANDIDATE_CVJOB
prompt ================================
prompt
create table PCACE.B_CANDIDATE_CVJOB
(
  dataid       NUMBER(11) not null,
  parentdataid NUMBER(9) not null,
  datasctlevel NUMBER(6) default -1,
...
alter table PCACE.B_CANDIDATE_CVJOB
...
prompt
prompt Creating table B_CANDIDATE_LANGUAGE
prompt ===================================
prompt
...
alter table PCACE.B_CANDIDATE_LANGUAGE
...
prompt
prompt Creating table ZA_COMPANY
prompt =========================
prompt
create table PCACE.ZA_COMPANY
(
  iid          NUMBER(14) not null,
  imemo        VARCHAR2(500),
  dataid       NUMBER(11),
...
prompt
prompt Creating table ZB_ACETASK
prompt =========================
prompt
create table PCACE.ZB_ACETASK
(
  iid          NUMBER(14) not null,
  imemo        VARCHAR2(500),
  dataid       NUMBER(11),
...
prompt
prompt Creating table ZB_CANDIDATE_CVJOB
prompt =================================
prompt
create table PCACE.ZB_CANDIDATE_CVJOB
(
  iid          NUMBER(14) not null,
  imemo        VARCHAR2(500),
  dataid       NUMBER(11),
...
prompt
prompt Creating sequence SEQB_CANDIDATE_HTCOMMENT
prompt ==========================================
prompt
create sequence PCACE.SEQB_CANDIDATE_HTCOMMENT
minvalue 1
maxvalue 99999999999999
start with 1
increment by 1
