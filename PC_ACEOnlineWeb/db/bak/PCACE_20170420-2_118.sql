...
-- Created by Administrator on 2017/4/20, 10:11:22 --
-----------------------------------------------------

set define off
spool PCACE_20170420-2_118.log
  ...
  begin
    ...
    if counter > 0 then
        ...
        update B_Candidate t set
               (c41,c38,c40,c42,c43,c44,c45)= (select distinct NVL(b.c2,a.c5), a.c7,decode(a.c4,'至今',1,0), a.c9, a.c11, a.c12, a.c13 from (select m.*,rank() over(order by m.c3 desc) ccc from B_Candidate_CVWork m where c1=a_cid and c2=130001 and c5 is not null) a, A_Organ b where ccc=1 and a.c5=b.c2(+)||'['||b.c1(+)||']')
         where c1=a_cid;
         
        update B_Candidate t set
               c64 = (select c5 from B_Candidate_CVWork where c1=a_cid and c2=130001 and c4='至今')
         where c1=a_cid and c64 is null;
