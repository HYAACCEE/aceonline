...
-- Created by Administrator on 2017/2/23, 15:15:54 --
-----------------------------------------------------

set define off
spool PCACE_20170223_02.log
...
create or replace package body pcace.pkg_pcace_web is
  ...
  begin
    ...
    --入库申请提交审核规则:R00003
    DECLARE CURSOR v_rs IS select b.c1,b.c2,b.c4,b.c5,b.c8 from Y_APPModule a, Y_APPModuleDetail b where a.dataid=b.parentDataid and a.c6=130001 and b.c9=130001 and a.c1='R00003' order by b.dataid;
    BEGIN
      open v_rs;
      LOOP
  ...
  begin
    ...
    --顾问面评审核规则:R00002
    DECLARE CURSOR v_rs IS select b.c1,b.c2,b.c4,b.c5,b.c8 from Y_APPModule a, Y_APPModuleDetail b where a.dataid=b.parentDataid and a.c6=130001 and b.c9=130001 and a.c1='R00002' order by b.dataid;
    BEGIN
      open v_rs;
      LOOP
        FETCH v_rs INTO v_title, v_type, v_tableName, v_content, v_index;
