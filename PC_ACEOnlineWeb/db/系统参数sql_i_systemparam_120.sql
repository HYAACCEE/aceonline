...
insert into pcace.I_SystemParam(id,paramClass,className,value,name,parentClass,isShow,state) values(404,'903','业务参数：文件服务器硬盘地址','903001','F:\Tomcat\webapps\fileserver\',null,1,1); --E:\Tomcat\webapps\fileserver\
insert into pcace.I_SystemParam(id,paramClass,className,value,name,parentClass,isShow,state) values(405,'904','业务参数：APP_Server地址','904001','http://120.27.249.104:8099/aceserver/',null,1,1); --http://118.178.126.204:8099/aceserver/
