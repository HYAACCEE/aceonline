...
insert into pcace.I_SystemParam(id,paramClass,className,value,name,parentClass,isShow,state) values(403,'902','业务参数：文件服务器web地址','902001','http://127.0.0.1/fileserver/',null,1,1); --http://118.178.126.204/fileserver/
